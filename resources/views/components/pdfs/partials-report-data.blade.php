            ...
            <tr>
                ...
                @for ($index = 0; $index < 12; $index++)
                    <td>
                        ...
                        @endphp
                        <x-report-indi-data-component :measurementPoint="$measurementPoint" :slotDate="$slotDate" />
                    </td>
                @endfor
                <td>
                    <x-report-indi-data-component :measurementPoint="$measurementPoint" :slotDate="$slotDate" type='1hLeq' />
                </td>
                <td rowspan="12">
